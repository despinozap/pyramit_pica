                ...
                <div class="panel-body">
					{!! Form::open(array('class'=>'frm')) !!}
						...
						<div class="form-group">
							...
							{!! Form::text('title', null, ['id' => 'frm_title', 'class' => 'form-control', 'placeholder' => 'Titulo del álbum', 'required']) !!}
...
@section('js')
	...
	<script type="text/javascript">
		...
		$('.frm').submit(function(e)
        {
            ...
            swal({
                    title: "Guardar álbum",
                    text: "¿Realmente deseas registrar el álbum \"" + title + "\"?",
                    type: "info",
                    ...
                    $.ajax(
                    {
                        ...
                        success: function (responseCode)
                        {
                            ...
                            switch (statusCode)
                            {
                                ...
                                case -1: //EXCEPTION
                                    {
                                        swal("Error", "¡Ha ocurrido un error al registrar el álbum!", "error");
                                ...
                                case 1: //SUCCESS
                                    {
                                        swal({
                                                title: "Guardado!",
                                                text: "El álbum se ha registrado con éxito",
                                                type: "success",
