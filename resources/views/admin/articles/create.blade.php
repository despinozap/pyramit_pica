                ...
                <div class="panel-body">
					{!! Form::open(array('class'=>'frm')) !!}
						...
						<div class="form-group">
							...
							{!! Form::text('title', null, ['id' => 'frm_title', 'class' => 'form-control', 'placeholder' => 'Titulo del artículo', 'required']) !!}
						...
						<div class="form-group">
							...
							{!! Form::select('category_id', $categories, null, ['id' => 'frm_category_id', 'class' => 'form-control select-category', 'required']) !!}
						...
						<div class="form-group">
							...
							{!! Form::textarea('content', null, ['id' => 'frm_content', 'class' => 'form-control textarea-content', 'required']) !!}
	...
	<script type="text/javascript">
		...
		$('.frm').submit(function(e)
        {
            ...
            swal({
                    ...
                    text: "¿Realmente deseas registrar el artículo \"" + title + "\"?",
                    type: "info",
                    ...
                    $.ajax(
                    {
                        ...
                        success: function (responseCode)
                        {
                            ...
                            switch (statusCode)
                            {
                                ...
                                case -1: //EXCEPTION
                                    {
                                        swal("Error", "¡Ha ocurrido un error al registrar el artículo!", "error");
